...
|:-------------------:|:-------------------------------------:|-----------------------------------------------------|
| :brain: Deep Learning | [Image Captioning with Vision Transformers and Attention Mechanisms](https://github.com/Oyebamiji-Micheal/Image-Captioning-with-Vision-Transformers-and-Attention-Mechanisms) | Implementing an image captioning model with attention insight with the Flick 30k dataset using ViT-Base/16 as the encoder and GPT-2 as the decoder
| | [Facial Reconstruction using Conditional Generative Adversarial Network (CGAN)](https://github.com/Oyebamiji-Micheal/Facial-Reconstruction-using-Conditional-Generative-Adversarial-Network) | Reconstructing occluded facial images of celebrities using conditional generative adversarial network
| | [Enhanced Search and Rescue Operation using Faster RCNN](https://github.com/Oyebamiji-Micheal/Enhanced-Search-and-Rescue-Operation-using-Faster-RCNN) | Enhancing Search and Rescue Operations in Post-Disaster Environments Using Faster R-CNN
...
| 💬 Natural Language Processing | [Inshorts News Headline Generation using Bidirectional and Auto-Regressive Transformers (BART) ](https://github.com/Oyebamiji-Micheal/Inshorts-News-Headline-Generation-using-BART) | Fine-tuning BART-Large model to generate concise news headlines
| | [Explaining Medical Terms in Hausa Machine Translation](https://github.com/Oyebamiji-Micheal/Explaining-Medical-Terms-in-Hausa-Machine-Translation) | Using SBERT and Text-To-Text Transfer Transformer for Explaining Medical Terms in Hausa Machine Translation
| | [English to Yoruba Translation using RNN](https://github.com/Oyebamiji-Micheal/English-to-Yoruba-Translation-using-RNN) | A beginner's approach to Sequence to Sequence modeling
| | [Analysing User Experience on E-Commerce Apps using NLP](https://github.com/Oyebamiji-Micheal/Analysing-User-Experience-on-E-Commerce-Apps-using-NLP) | Analysing user experience on Alibaba, Amazon, Flipkart, Nyakaa and Shopify app on Google Play Store | 
...
| | [Food Nutrition Analysis](https://github.com/Oyebamiji-Micheal/Food-Nutrition-Analysis) | Exploratory Data Analysis and Predictive Modelling of Food Nutrition Dataset
