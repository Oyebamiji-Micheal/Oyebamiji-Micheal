...
|:-------------------:|:-------------------------------------:|-----------------------------------------------------|
| :brain: Deep Learning | [Facial Reconstruction using Conditional Generative Adversarial Network (CGAN)](https://github.com/Oyebamiji-Micheal/Facial-Reconstruction-using-Conditional-Generative-Adversarial-Network) | Reconstructing occluded facial images of celebrities using conditional generative adversarial network
